...
__dword __API__ crc32(__byte *data, __integer length) {
	__dword CRC = 0xffffffff;
...
__bool __API__ crc32_selftests() {
	...
	bSuccess &= crc32((__memory)crc_32_tab, sizeof crc_32_tab) == __CRC_SELFTEST__;
